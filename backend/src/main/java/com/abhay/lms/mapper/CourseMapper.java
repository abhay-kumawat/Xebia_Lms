...
public class CourseMapper {
    ...
    private static ModuleResponseDTO mapModuleToResponseDTO(com.abhay.lms.entity.learning.ModuleEntity module) {
        if (module == null) return null;
        List<com.abhay.lms.dto.SubmoduleResponseDTO> submoduleDTOs = null;
        if (module.getSubmodules() != null) {
            submoduleDTOs = module.getSubmodules().stream()
                    .sorted(Comparator.comparing(com.abhay.lms.entity.learning.SubmoduleEntity::getSubmoduleOrder))
    ...
    private static com.abhay.lms.dto.SubmoduleResponseDTO mapSubmoduleToResponseDTO(com.abhay.lms.entity.learning.SubmoduleEntity submodule) {
        if (submodule == null) return null;
        List<com.abhay.lms.dto.ContentResponseDTO> contentDTOs = null;
        if (submodule.getContents() != null) {
            contentDTOs = submodule.getContents().stream()
                    .sorted(Comparator.comparing(com.abhay.lms.entity.learning.ContentEntity::getContentOrder))
                    .map(content -> com.abhay.lms.dto.ContentResponseDTO.builder()
                            .id(content.getId())
        ...
        return com.abhay.lms.dto.SubmoduleResponseDTO.builder()
                .id(submodule.getId())
    ...
    public static CourseResponseDTO toResponseDTO(CourseEntity entity) {
        ...
        if (entity.getModules() != null) {
            moduleDTOs = entity.getModules().stream()
                    .sorted(Comparator.comparing(com.abhay.lms.entity.learning.ModuleEntity::getModuleOrder))
