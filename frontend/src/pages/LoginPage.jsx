...
export default function LoginPage() {
  ...
  const [password, setPassword] = useState(
    location.state?.email === 'admin@xebia.com' ? 'admin123' :
    location.state?.email === 'john.doe@xebia.com' ? 'trainer123' :
    location.state?.email === 'sarah.c@xebia.com' ? 'manager123' : ''
  );
      ...
      >
        ...
        <div className="flex flex-col items-center justify-center text-center">
          ...
          <p className="mt-2 text-sm text-brand-text-secondary">
            Sign in to the Xebia Academy Admin Panel
          </p>
        </div>
