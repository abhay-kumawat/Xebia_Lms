...
export default function LoginSelectorPage() {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-brand-surface px-4 py-12 overflow-hidden select-none">
      {/* Background radial glows */}
      <div className="absolute top-[-10%] left-[-10%] h-[50%] w-[50%] rounded-full bg-accent-teal/5 blur-[120px]" />
      <div className="absolute bottom-[-10%] right-[-10%] h-[50%] w-[50%] rounded-full bg-brand-secondary/5 blur-[120px]" />
      ...
      >
        ...
        <div className="mt-8 grid gap-4 grid-cols-1 md:grid-cols-3">
          ...
          >
            <div>
              <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-br from-[#831B84]/10 to-[#FF6200]/10 text-[#831B84] group-hover:scale-110 transition-transform">
            ...
            <div className="mt-6 flex items-center justify-between text-xs font-bold text-[#831B84]">
